(function () {
    ...
    var printerMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'printer', {}) );
        }
    };
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("PRINTER_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("printer/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.PRINTER_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var printer = normalizeComponent_1(
    ...
    var lang = {
        PRINTER_EXAMPLE: 'printer example',
    };
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('printer', printerModule);
            AWEMA.lang = lang;
        }
    };
